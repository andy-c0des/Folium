...
function plantosEnsureOptionalColumns() {
  ...
  const desired = [H.POT_MATERIAL, H.POT_SHAPE, H.CULTIVAR, H.HYBRID_NOTE, H.INFRA_RANK, H.INFRA_EPITHET, H.LAST_REPOTTED, H.LAST_PROGRESS_UPDATE, H.PROGRESS_STATUS];
  const added = [];
